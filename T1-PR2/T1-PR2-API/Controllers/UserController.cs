...
namespace T1_PR2_API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var usuari = new User { UserName = model.Name, Email = model.Email };
        ...
        {
            var usuari = new User { UserName = model.Name, Email = model.Email, Name = model.Name, Surname = model.Surname };
            var resultat = await _userManager.CreateAsync(usuari, model.Password);
